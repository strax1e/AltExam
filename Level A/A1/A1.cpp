...
Комментарий: 
Задача на внимательность чтения условия.
...
Замечание: 
Также эта задача решается с помощью алгоритма Евклида и перебора, но уложиться в ограниченное время не получится.
